...
public class GTS_Halaman_KategoriLock extends AppCompatActivity implements ItemAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.halaman_kategori_lock);
    ...
    private void aturClickListener() {
        back.setOnClickListener(view -> {
            Intent intent = new Intent(GTS_Halaman_KategoriLock.this, GTS_Halaman_Utama.class);
        ...
        referensiDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (itemData != null && itemData.getKategori() != null && itemData.getKategori().equalsIgnoreCase("Lock")) {
    ...
    private void cariItem(String keyword) {
        ...
        ItemAdapter adapterPencarian = new ItemAdapter(GTS_Halaman_KategoriLock.this, hasilPencarian);
    ...
    public void onDetailButtonClicked(ItemData item) {
        Intent intent = new Intent(GTS_Halaman_KategoriLock.this, GTS_Halaman_Detail.class);
        intent.putExtra("id_barang", item.getId());
        startActivity(intent);
    }

    private void tampilkanAlert10() {
        final alert10 alert10 = new alert10(GTS_Halaman_KategoriLock.this);
        alert10.startLoding();
